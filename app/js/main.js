...
riot.tag2('scanner', '<video id="cameraOutput" autoplay="true"> </video> <hr> <input type="file" accept="image"> <img src="./data/img/10000000 - visit virttruhe.tumblr.com.png" id="img">', '', '', function(opts) {
